...
(function(ext) {
  ...
  var descriptor = {
    blocks: [
      ...
      [' ', 'σύνδεσε %m.hwIn στο αναλογικό %n', 'connectHW', 'rotation knob', 0],
      ['-'],
      [' ', 'turn %m.leds %m.outputs', 'digitalLED', 'led A', 'on'],
      [' ', 'set %m.leds brightness to %n%', 'setLED', 'led A', 100],
      [' ', 'change %m.leds brightness by %n%', 'changeLED', 'led A', 20],
      ['-'],
      [' ', 'περίστρεψε το %m.servos στις %n μοίρες', 'rotateServo', 'servo A', 180],
      [' ', 'περίστρεψε το %m.servos κατά %n μοίρες', 'changeServo', 'servo A', 20],
      ['-'],
